...
@pytest.mark.anyio
async def test_truncate_tool_response_callback_preserves_full_payload() -> None:
    mock_tool = MagicMock()
...
@pytest.mark.webhook_agent
@pytest.mark.anyio
async def test_message_pruning_plugin() -> None:
...
@pytest.mark.webhook_agent
@pytest.mark.anyio
async def test_save_large_data_artifact() -> None:
