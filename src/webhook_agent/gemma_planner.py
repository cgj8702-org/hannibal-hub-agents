...
def _build_event_prompt(event: PlannerEvent, trace_id: str) -> str:
    ...
    return (
        ...
        "3. When a real user comments on an issue or pull request, you MUST "
        "respond. The user is engaging with the agent — treat this as a "
        "conversation and reply appropriately. Do NOT treat user comments as "
        "'no action needed' simply because they lack explicit commands like "
        "/review.\n"
