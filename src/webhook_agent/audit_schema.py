...
class RiskItem(BaseModel):
    ...
    category: Literal["concurrency", "memory", "security", "breaking_change", "none"] = Field(
    ...
    remediation: str = Field(description="Recommended safeguard or code mitigation strategy")
